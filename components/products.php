<?php
require_once './sql/get-products.php';
...
<section class="container mx-auto mt-4 p-4 rounded-lg">
  <h2 class=" text-gray-800 text-3xl font-semibold mb">Todos los Productos</h2>
</section>
      ...
      <div class="bg-white p-4 shadow-md border-gray-500 rounded-lg hover:shadow-xl cursor-pointer">
        <div class="images-product mb-5 h-64">
          ...
          foreach ($producto['imagenes'] as $ruta) {
            echo '<img src="' . $ruta . '" alt="Imagen del producto" class="w-full h-64 rounded-md object-contain" loading="lazy">';
          }
          ?>
        </div>
